...
public:
	CPluginBase(){ }
	virtual LPCTSTR GetName() = 0;		//插件名称（少于10文字）
	virtual LPCTSTR GetIntro() = 0;	//插件简介（少于20文字）
	virtual LPCTSTR GetAuthor() = 0;	//插件作者
	virtual PluginVersion_st GetVersion() = 0; //插件版本号
